define(`m4_feedback_recipients',`csteele\@mtron.com')
define(`m4_contact_recipients',`csteele\@mtron.com')
define(`m4_log_file',`/home/csteele/test/parametric.log')
define(`m4_version',`1.1.0-3')
#!/usr/bin/perl
...
@main::contact_recipients = ( "m4_feedback_recipients" );
