define(`m4_catreq_recipients',`"sluchtel\@mtron.com", "hhungate\@mtron.com"')
define(`m4_real_referer',`http://argo.mtron.com/catform.html')
# filename: Catreq.pl
...
@main::catreq_recipients = ( m4_catreq_recipients );
