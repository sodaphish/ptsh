...
def main():
	print "dRCON %s -- distributed RCON" % ( VERSION )
	print "...by |WC|SodaPhish <sodaphish@gmail.com>\n" 
...
if __name__ == '__main__':
	...
	while not cursor.EOF:
		...
		servers.append( GameServer( arr['serverip'], arr['serverport'], arr['serverrcon'] ) )
		cursor.MoveNext()
	cursor.Close()
	conn.Close()
	main()
