...
#TODO: CJS 8/12/2010 - break out the actual loading of a plugin into a separate routine.  
...
def refresh_plugins(CPEM_Server,path='%s/plugins/' % (os.getcwd()),pluginName=''):
    ...
    #TODO (CJS: 2011/10/16) - need to be able to selectively re-initialize an individual plugin.
