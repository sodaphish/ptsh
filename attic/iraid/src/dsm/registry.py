...
"""
Registry.py by C.J. Steele <coreyjsteele@gmail.com>

A library/class to handle an abstract registry interface.


This library requires Python3 because of dictionaries used in getScope()

If you're going to hack around this version requirement, then I suggest 
you make certain that you fix getScope() and email me a patch.
"""
