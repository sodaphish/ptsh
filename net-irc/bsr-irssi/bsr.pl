...
#		- check all input for valid size and format. (v.0.3.0)
...
#			!bsr unregister
#			!bsr savestate
#		- support for '!bsr stats' which lists top ten status setters (v.0.4.0)
#			new commands are: 
#			!bsr stats
#		- support of "BSR Admins" who can change tot and buttgorithms (v.0.5.0)
#			new commands are:
#			!bsr bgrthms add "(_X_)" "description"
#			!bsr bgrthms remove "(_X_)"
#			!bsr bgrthms edit "(_X_):descr" "(_Y_):descr2"
#
#  BSR DATA STRUCTURES
#  @BSR = ( 
#		{ 
