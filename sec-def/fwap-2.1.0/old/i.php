...
switch( $f ){
	...
	case 'top10':
		...
		{
			print "<li><a href=http://frank.corp.good-sam.com/sec/fwap/$this?f=drilldown&q=$ip>$ip</a> ($ct)</li>\n";
		}
		print "</ol>"; 
	...
	case 'viewday':
		if( $q ){
			...
			print "
				<div align=center>
					<a href=$this><img src=http://frank.corp.good-sam.com/sec/fwap/fwap.png border=0></a><br>
					<h1>F.W.A.P. Report for $q</h1>
				<table width=600>
				<tr>
					<td colspan=2 valign=top>
						<div align=center>
							<a href=http://frank.corp.good-sam.com/sec/fwap/stats.php><img src=\"http://frank.corp.good-sam.com/sec/fwap/stats.php?date=$q&type=total\" border=0></a>
						</div>
						<br><br><hr>
					</td>
				</tr>
			...
			{
				print "<li><a href=\"javascript:onclick=popupwindow('http://frank.corp.good-sam.com/sec/fwap/$this?f=odrill&p=$m', 'odrill', '750', '400' )\">details</a> $m</li>\n";
			}
			print "</td></tr></table></div>"; 
		} else {

			print "<h3>No date specified, click <a href=http://frank.corp.good-sam.com/sec/fwap/$this>here</a>.</h3>\n";
...
print "<br><br><br><div class=\"footer\">$query_count queries executed in $time seconds</div><br>\n";
