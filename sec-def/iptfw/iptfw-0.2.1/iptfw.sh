...
TRUSTED=`/usr/local/sbin/whatsmylan $INTINT`
...
#########################################################################
$IPTABLES -A INPUT -p tcp -j LOG --log-level=5 --log-prefix="firewall "
$IPTABLES -A INPUT -p udp -j LOG --log-level=5 --log-prefix="firewall "
$IPTABLES -A INPUT -p icmp -j LOG --log-level=5 --log-prefix="firewall "
$IPTABLES -A INPUT -p ip -j LOG --log-level=5 --log-prefix="firewall "
